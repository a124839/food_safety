  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">算法管理</a></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
            	<div class="form-group">
                  <label for="instrumentName" class="col-sm-1 control-label">算法名称</label>
              ...
              <div class="form-group">
                <shiro:hasPermission name="algorithmManageAdd">
...
<!-- ./wrapper -->
	...
	<script	src="${pageContext.request.contextPath }/js/biz/algorithm/algorithm_biz.js?ver=${ver}" type="text/javascript"></script>
