  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">算法编辑</a></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <input type="hidden" value="${algorithm.id}" id="algorithmId">
                <label for="instrumentName" class="col-sm-2 control-label">算法名称</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="algorithmName" placeholder="算法名称" value="${algorithm.name}">
                </div>
                <label for="instrumentName" class="col-sm-1 control-label">算法类型</label>
                <div class="col-sm-4">
                  <select class="form-control" id="algorithmType">
                    <option value="1" <c:if test="${algorithm.type == 1}">selected = selected</c:if> >预处理</option>
                    <option value="2" <c:if test="${algorithm.type == 2}">selected = selected</c:if>>评价</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="sampleCode" style="height:200px;">${algorithm.sampleCode}</textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="example" style="height:200px;">${algorithm.example}</textarea>
              ...
              <div id="params">
                <c:forEach items="${params}" var="o">
                  <div class="form-group">
                    ...
                    <label for="instrumentName" class="col-sm-2 control-label">参数名称</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="paramsName" placeholder="参数名称" value="${o.name}">
                    </div>
                    <label for="instrumentName" class="col-sm-1 control-label">默认值</label>
                    <div class="col-sm-4">
                      <input type="text" name="paramsValue" class="form-control"placeholder="默认值" value="${o.value}">
                    </div>
                  </div>
                </c:forEach>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" name="memo" style="height:100px;">${algorithm.memo}</textarea>
            ...
            <div class="form-group">
              <div class="col-sm-6">
                <button type="button" class="btn btn-primary pull-right" onclick="edit();" id="saveBtn">保存</button>
              </div>
              <div class="col-sm-6">
