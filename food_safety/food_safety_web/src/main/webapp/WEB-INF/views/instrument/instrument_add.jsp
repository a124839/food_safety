            ...
            <form class="form-horizontal" id="instrumentForm" enctype="multipart/form-data" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="purchaseDate" readonly="readonly"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="installStartDate" readonly/>
                  </div>
                  <label class="col-sm-1 control-label">安装结束日期</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="installEndDate" readonly/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <input type="text" class="form-control" name="performances"/>
                      </div>
                  </div>
                ...
                <div class="form-group">
                  <div class="col-sm-6">
                    <button type="button" class="btn btn-primary pull-right" onclick="saveInstrument();" id="saveBtn">保存</button>
                  </div>
                  <div class="col-sm-6">
