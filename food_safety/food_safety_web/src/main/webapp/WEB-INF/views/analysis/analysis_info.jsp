                ...
                <div class="box-body">
                 ...
                 <div class="form-group">
                   <table class="table table-bordered text-center">
                     <tr>
                       <td><b>算法名称</b></td><td colspan="3">${algorithm.name}</td>
                     </tr>
                  ...
                  <div class="form-group">
                    <div class="col-sm-6">
                      <button type="button" class="btn btn-primary pull-right" onclick="saveAnalysisResult();">保存</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="button" class="btn btn-primary" onclick="toImportDataPage();">导入</button>
                    </div>
                  </div>
                </div>
            </form>
