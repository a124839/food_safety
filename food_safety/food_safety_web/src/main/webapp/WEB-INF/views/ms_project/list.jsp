  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">多源实验管理</a></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
            	<div class="form-group">
                  <label for="userName" class="col-sm-1 control-label">实验名称</label>
              ...
              <table id="example2" class="table table-bordered table-hover text-center ">
                ...
                <tr>
                  ...
                  <td><a href="javascript:selectData()">选择数据</a></td>
                </tr>
                </tbody>
              </table>
                <div class="form-group">
...
<!-- ./wrapper -->
	...
	<script	src="${pageContext.request.contextPath }/js/biz/ms_project/msproject_biz.js?ver=${ver}" type="text/javascript"></script>
