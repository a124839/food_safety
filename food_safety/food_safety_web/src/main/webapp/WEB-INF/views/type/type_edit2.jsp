  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">修改服务类型</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" id="serviceTypeForm" enctype="multipart/form-data" method="post" >
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-6">
                    <button type="button" class="btn btn-primary pull-right" onclick="saveServiceType();">保存</button>
                  </div>
                  <div class="col-sm-6">
...
<!-- ./wrapper -->
    ...
    <script src="${pageContext.request.contextPath }/js/biz/type/type_add2.js?ver=${ver}" type="text/javascript"></script>
</body>
</html>