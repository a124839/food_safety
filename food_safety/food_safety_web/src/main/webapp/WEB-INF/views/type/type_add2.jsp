  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">添加服务类型</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" id="serviceTypeForm" method="post" >
              <div class="box-body">
                <!-- 内容 -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <button type="button" class="btn btn-primary" onclick="saveServiceType();" id="saveBtn" >保存</button>
                    <button type="button" class="btn btn-info pull-right" onclick="toListPage();">取消</button>
                  </div>
                </div>
