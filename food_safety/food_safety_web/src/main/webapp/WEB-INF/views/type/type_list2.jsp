  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">服务类型管理</a></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
            	<div class="form-group">
                  <label for="instrumentName" class="col-sm-2 control-label">服务类型</label>
            ...
            <div class="form-group">
                <shiro:hasPermission name="serviceTypeManageAdd">
...
<!-- ./wrapper -->
	...
	<script	src="${pageContext.request.contextPath }/js/biz/type/type_biz2.js?ver=${ver}" type="text/javascript"></script>
