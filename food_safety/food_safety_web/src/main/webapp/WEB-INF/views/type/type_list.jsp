  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">样品种类管理</a></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
            	<div class="form-group">
                  ...
                  <label for="instrumentName" class="col-sm-2 control-label">样品种类</label>
            ...
            <div class="form-group">
                <shiro:hasPermission name="sampleTypeLv2ManageAdd">
...
<!-- ./wrapper -->
	...
	<script	src="${pageContext.request.contextPath }/js/biz/type/type_biz.js?ver=${ver}" type="text/javascript"></script>
