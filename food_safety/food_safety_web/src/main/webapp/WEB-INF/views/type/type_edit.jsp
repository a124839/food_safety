  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">修改样品种类</a></li>
      </ol>
    </section>
...
<%--                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="radio" name="category" <c:if test="${type.parentId == 0}">checked="checked"</c:if> value="1"/>
                  </div>

                  <label class="col-sm-4 control-label">种类</label>
                  <div class="col-sm-2">
                    <input type="radio"  name="category" value="2" <c:if test="${type.parentId != 0}">checked="checked"</c:if>/>
                  </div>
                </div>--%>
                <div id="cateloryLv1"  >
                <div class="form-group">
                  <label for="instrumentName" class="col-sm-2 control-label">类别</label>
                  <div class="col-sm-9">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="memo" style="height:100px;">${type.memo}</textarea>
                ...
                <div class="form-group">
                  <div class="col-sm-6">
                    <button type="button" class="btn btn-primary pull-right" onclick="saveType();">保存</button>
                  </div>
                  <div class="col-sm-6">
