  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">修改实验信息</a></li>
      </ol>
    </section>
            ...
            <form class="form-horizontal" id="projectForm" enctype="multipart/form-data" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="startDate" readonly value="<fmt:formatDate value="${project.startDate}" type="date" pattern="yyyy-MM-dd"/>"/>
                  </div>

                  <label class="col-sm-1 control-label">结束时间</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="endDate" readonly="readonly" value="<fmt:formatDate value="${project.endDate}" type="date" pattern="yyyy-MM-dd"/>"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-1 control-label">实验方案</label>
                  <div class="col-sm-5">
                    <input type="file" class="form-control" name="schemaAttachment"/><a href="#">删除</a>
                  </div>
                  <label class="col-sm-1 control-label">实验标准</label>
                  <div class="col-sm-5">
                    <input type="file" class="form-control" name="standardAttachment"/><a href="#" >删除</a>
                  </div>
                ...
                <div class="form-group">
                  <div class="col-sm-6">
                    <button type="button" class="btn btn-primary pull-right" onclick="saveProject();">保存</button>
                  </div>
                  <div class="col-sm-6">
