		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a href="#">SST</a></li>
				</ol>
			</section>
							...
							<div class="box-header">
								...
								<div class="">
									<p>
										&nbsp;&nbsp;&nbsp;
										<mark>
											function SST算法用于模型转移:[ Xc_after ] = sst( Xm,Xs,Xc,n_comp )
										</mark>
									</p>
									<p>
										&nbsp;&nbsp;&nbsp;
								...
								<form method="post" action="" id="dataAnalysisForm">
									<input type="hidden" id="dataAnalysisSSTParams" name="sstParams">
								</form>


								<!-- 2. 选择数据 -->
								<!-- 2.1 显示选择数据按钮及参数 -->
								<form role="form" id="dataAnalysisSST" class="form-horizontal">
									<div class="col-sm-12">
										<h2>
											<label>SST参数选择</label>
										</h2>
									</div>
									<div id="sstSelectParams" class="form-group">
										<div class="col-sm-2 ">
										...
										<div class="col-sm-2 col-sm-offset-10">
											...
											<button type="button" class="btn btn-primary"
												onclick="analysisSSTData();" id="handleData">开始处理</button>
										</div>
...
<!-- 	</div> -->
	...
	<script
		src="${pageContext.request.contextPath }/js/biz/dataAnalysis/dataAnalysisSST_biz.js?ver=${ver}"
		type="text/javascript"></script>
