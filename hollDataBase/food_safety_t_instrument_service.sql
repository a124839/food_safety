...
--
-- Table structure for table `t_instrument_service`
--
...
--
-- Dumping data for table `t_instrument_service`
--

LOCK TABLES `t_instrument_service` WRITE;
/*!40000 ALTER TABLE `t_instrument_service` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_instrument_service` ENABLE KEYS */;
UNLOCK TABLES;
